...
public enum CleanlinessEnum {
    ...
    CleanlinessEnum(String value, String text) {
        this.value = value;
        this.text = text;
    }

    public static String getTextByValue(String value) {
        for (CleanlinessEnum cleanlinessEnum : CleanlinessEnum.values()) {
            if (cleanlinessEnum.value.equals(value)) {
                return cleanlinessEnum.getText();
            }
        }
        return "";
    }
